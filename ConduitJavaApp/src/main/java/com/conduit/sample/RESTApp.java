...
public class RESTApp {
    ...
    public static void main(String[] args) {
        ...
        restQueryService.verifyExistingConnectors(appConfg.getConnectionUrl());
        String sql = "SELECT * FROM " + appConfg.getTypeName() + "_" + appConfg.getConnectionUrl() + "." + appConfg.getTables().get(0) + " limit 10";
